...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/startevaluation.css">
    </head>
    <body>
            ...
            <main class="dashboard-main">
                ...
                <div class="card">
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-box">
                            <span class="stat-value">${submittedScores}</span>
                            <span class="stat-label">Scores Submitted</span>
                        </div>
                        <div class="stat-box">
                            <span class="stat-value">${expectedScores}</span>
                            <span class="stat-label">Expected Scores</span>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="weightage-grid">
                        <div class="weightage-item">
                            ...
                            <span class="weightage-desc">(Lowest Bid / This Bid) × 100</span>
                        </div>
                        <div class="weightage-item">
                            <span class="weightage-label">Technical Compliance</span>
                            <span class="weightage-value">35%</span>
                            <span class="weightage-desc">Evaluator enters score (0-100)</span>
                        </div>
                        <div class="weightage-item">
                            <span class="weightage-label">Delivery Timeline</span>
                            <span class="weightage-value">25%</span>
                            <span class="weightage-desc">(Shortest Timeline / This Timeline) × 100</span>
                        </div>
                    </div>
                </div>
